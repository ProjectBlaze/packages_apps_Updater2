 ...
 */
package com.blaze.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "org.blaze.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.blaze.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.blaze.buildtype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "blaze.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "blaze.updater.uri";
